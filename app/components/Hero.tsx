...
export default function Hero() {
  return (
    <section className="relative pt-24 pb-32 overflow-hidden bg-[#FAFAFA] text-zinc-950">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.h1 variants={fadeUpItem} className="text-5xl sm:text-6xl md:text-7xl lg:text-[6.5rem] font-bold tracking-tighter mb-6 leading-[1.05] text-zinc-950">
            Design your <br />
          ...
          <motion.div variants={fadeUpItem} className="flex flex-wrap items-center justify-center gap-6 md:gap-10 text-xs font-semibold uppercase tracking-widest text-zinc-400 mb-24">
